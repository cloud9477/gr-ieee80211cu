...
#ifndef INCLUDED_IEEE80211CU_DEMODCU_IMPL_H
#define INCLUDED_IEEE80211CU_DEMODCU_IMPL_H
...
namespace gr {
  namespace ieee80211cu {
    ...
    class demodcu_impl : public demodcu
    {
     ...
     public:
      demodcu_impl(int mupos, int mugid, bool ifdebug);
      ~demodcu_impl();
...
#endif /* INCLUDED_IEEE80211CU_DEMODCU_IMPL_H */
